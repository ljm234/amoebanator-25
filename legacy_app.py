# Legacy Phase 1.3 Streamlit entry — preserved for reference.
# Phase 4.5 web layer lives in app/ package; Mini-2 ships app/app.py
# as the new st.navigation entry point. Do not edit this file.
import json
import platform
