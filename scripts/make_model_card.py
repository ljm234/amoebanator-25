...
def main() -> None:
    ...
    lines += [
        ...
        *deps,
        ...
        "",
        "## References",
        "- Calibration: temperature scaling & post-hoc recalibration (Minderer et al., NeurIPS 2021; Gruber & Buettner, NeurIPS 2022).",
        "- Decision-curve analysis for clinical net-benefit (Vickers, Kerr & Van Calster, Stat Med 2023).",
