# AUDIT bundle: PMID 15496623 | Thwaites 2004
...
## Anchor: PMID 15496623 | Thwaites 2004
...
```json
{
  ...
  "caveat": "Subphase 1.4 commit 5.4.0 anchor for Class 4 TBM. HCMC Vietnam dexamethasone RCT in adolescents and adults with TBM; mortality reduction with adjunctive dexamethasone. 21-author Vancouver list confirmed via PubMed UI. verification_confidence=0.85 pre-direct-fetch."
}
```
...
```json
{
  ...
  "title": "Dexamethasone for the treatment of tuberculous meningitis in adolescents and adults.",
  "sorttitle": "dexamethasone for the treatment of tuberculous meningitis in adolescents and adults",
  "volume": "351",
  "issue": "17",
  "pages": "1741-51",
  "lang": [
  ...
  "references": [
    {
      "refsource": "N Engl J Med. 2004 Oct 21;351(17):1719-20. doi: 10.1056/NEJMp048227.",
      "reftype": "Comment in",
      "pmid": 15496620,
      "note": ""
    },
    {
      "refsource": "N Engl J Med. 2004 Oct 21;351(17):1792-4. doi: 10.1056/NEJMe048223.",
      "reftype": "Comment in",
      "pmid": 15496631,
      "note": ""
    },
    {
      "refsource": "N Engl J Med. 2005 Feb 10;352(6):628-30; author reply 628-30. doi: 10.1056/NEJM200502103520620.",
      "reftype": "Comment in",
      "pmid": 15703433,
      "note": ""
    },
    {
      "refsource": "N Engl J Med. 2005 Feb 10;352(6):628-30; author reply 628-30.",
      "reftype": "Comment in",
      "pmid": 15706645,
      "note": ""
    },
    ...
    {
      "refsource": "Curr Neurol Neurosci Rep. 2006 Nov;6(6):451-2. doi: 10.1007/s11910-006-0045-4.",
      "reftype": "Comment in",
      "pmid": 17074278,
      "note": ""
    }
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2004/10/21 00:00",
  "sortfirstauthor": "Thwaites GE",
  "vernaculartitle": ""
}
```
...
- **pages**: registry='1741-1751' | ncbi='1741-51'

### Vignettes citing this anchor (6 total)

#### Vignette: vid=121 file=tbm_121_thwaites_hcmc_adult_pilot.json class=4 subphase=1.4 TBM pilot
...
VITALS:
  T:38.4C HR:96 BP:122/78 GCS:13 SpO2:96% RR:18
...
LABS:
  WBC:8400 Plt:312000 ALT/AST:28 CRP:38.0 PCT:0.4 Na:128

CSF:
  OP:24.0cmH2O  WBC:280/mm3  lymph%:78 neut%:20 eos%:2
  glucose:28mg/dL protein:280mg/dL lactate:4.4mmol/L ADA:14.0U/L
...
#### Vignette: vid=123 file=tbm_123_thwaites_hcmc_adult_male_cnpalsy_wave1.json class=4 subphase=1.4 TBM wave_1
...
DEMOGRAPHICS:
  age_years: 28  sex: male  region: other_global
  ethnicity: asian  altitude_m: 19
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:38.6C HR:102 BP:124/78 GCS:12 SpO2:96% RR:18
...
LABS:
  WBC:8800 Plt:296000 ALT/AST:26 CRP:42.0 PCT:0.4 Na:130

CSF:
  OP:22.0cmH2O  WBC:320/mm3  lymph%:78 neut%:20 eos%:2
...
#### Vignette: vid=124 file=tbm_124_thwaites_hcmc_adult_male_fatal_wave1.json class=4 subphase=1.4 TBM wave_1
...
VITALS:
  T:39.2C HR:124 BP:108/64 GCS:8 SpO2:92% RR:28
...
LABS:
  WBC:11600 Plt:188000 ALT/AST:48 CRP:78.0 PCT:0.9 Na:126

CSF:
  OP:30.0cmH2O  WBC:400/mm3  lymph%:72 neut%:26 eos%:2
  glucose:18mg/dL protein:380mg/dL lactate:4.4mmol/L ADA:17.0U/L
  crag_lfa:negative  wet_mount:negative  xanthochromia:False  RBC:2
...
#### Vignette: vid=125 file=tbm_125_thwaites_hcmc_pregnancy_female_wave1.json class=4 subphase=1.4 TBM wave_1
...
DEMOGRAPHICS:
  age_years: 41  sex: female  region: other_global
  ethnicity: asian  altitude_m: 19
  hiv_status: negative  cd4: None
...
VITALS:
  T:38.4C HR:96 BP:118/72 GCS:13 SpO2:97% RR:18
...
LABS:
  WBC:7600 Plt:248000 ALT/AST:28 CRP:36.0 PCT:0.3 Na:132
...
#### Vignette: vid=126 file=tbm_126_thwaites_hcmc_young_male_cnpalsy_wave1.json class=4 subphase=1.4 TBM wave_1
...
VITALS:
  T:38.0C HR:92 BP:122/76 GCS:14 SpO2:97% RR:18
...
LABS:
  WBC:7200 Plt:318000 ALT/AST:24 CRP:28.0 PCT:0.3 Na:134

CSF:
  OP:18.0cmH2O  WBC:180/mm3  lymph%:82 neut%:16 eos%:2
...
#### Vignette: vid=127 file=tbm_127_thwaites_hcmc_adult_male_smearpos_wave1.json class=4 subphase=1.4 TBM wave_1
...
DEMOGRAPHICS:
  age_years: 38  sex: male  region: other_global
  ethnicity: asian  altitude_m: 19
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:38.5C HR:100 BP:128/80 GCS:13 SpO2:96% RR:18
...
LABS:
  WBC:9200 Plt:286000 ALT/AST:32 CRP:48.0 PCT:0.5 Na:128

CSF:
  OP:26.0cmH2O  WBC:360/mm3  lymph%:75 neut%:23 eos%:2
  glucose:24mg/dL protein:320mg/dL lactate:4.4mmol/L ADA:16.0U/L
  crag_lfa:negative  wet_mount:negative  xanthochromia:False  RBC:2
