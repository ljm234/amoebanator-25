# AUDIT batch: class=pam batch=3/4

Generated: 2026-05-11
Vignettes in bundle: 11
Anchors in bundle: 10
Build status: NCBI fetched (mixed)
Bundle type: CLASS-LOCKED-BATCH (class pam, small clusters packed)

## Anchors in this batch

- pmid:15504272 (Cogo 2004, n=1)
- pmid:39606118 (Lin 2024, n=1)
- pmid:37727924 (Hong 2023, n=1)
- pmid:25667249 (Linam 2015, n=1)
- pmid:30055569 (Wang 2018, n=1)
- pmid:34906097 (Huang 2021, n=1)
- pmid:39860533 (Rîpă 2025, n=1)
- pmid:32369575 (Gharpure 2021, n=2)
- pmid:19845995 (Yoder 2010, n=1)
- pmid:35463884 (Zhou 2022, n=1)

## Anchor: PMID 15504272 | Cogo 2004
...
```json
{
  ...
  "alias_rationale": "PubMed XML truncates author 2 surname mid-string ('Scaglia' -> 'Scagli'; trailing 'a' lost in early NLM ingest of this 2004 dispatch). Canonical 'Scaglia M' confirmed by: (1) CDC EID publisher byline at top of article 'Massimo Scaglia + University-IRCCS S. Matteo, Pavia, Italy', (2) PMC3323261 full-text rendering, (3) Massimo Scaglia documented researcher with prior Naegleria papers (PMID 3587066 Microbiologica 1987, Trans R Soc Trop Med Hyg 1983, Exp Parasitol 1989), (4) Padova/Pavia institutional records. PubMed UI fetch 2026-05-05 confirmed 'Scagli M' truncation persists in NLM index. Verified user_pubmed_ui_direct_fetch on this entry to lock the dual-form decision.",
  ...
  "caveat": "9yo immunocompetent boy Italy (Veneto/Padova region, admitted Este hospital); swam in polluted Po River water hole July 2003 ~10d pre-onset; FIRST documented Italian PAM case; postmortem dx by IIF + histology; N. fowleri genotype I (genotype 1) by PCR; FATAL. 9 authors. NLM truncation artifact: PubMed XML shows 'Scagli M' but canonical published byline = 'Scaglia M' (Massimo Scaglia, University-IRCCS S. Matteo, Pavia). Authors: Paola E. Cogo, Massimo Scaglia, Simonetta Gatti, Flavio Rossetti, Rita Alaggio, Anna Maria Laverda, Ling Zhou, Lihua Xiao, Govinda S. Visvesvara."
}
```
...
```json
{
  ...
  "lastauthor": "Visvesvara GS",
  "title": "Fatal Naegleria fowleri meningoencephalitis, Italy.",
  "sorttitle": "fatal naegleria fowleri meningoencephalitis italy",
  "volume": "10",
  "issue": "10",
  "pages": "1835-7",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC3323261;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.3201/eid1010.040273"
    }
  ],
  "history": [
    {
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2004/10/01 00:00",
  "sortfirstauthor": "Cogo PE",
  "vernaculartitle": ""
}
```
...
- **pages**: registry='1835-1837' | ncbi='1835-7'

### Vignettes citing this anchor (1 total)

#### Vignette: vid=022 file=pam_d2_022_cogo_italy_first_european.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 9  sex: male  region: other_global
  ethnicity: other  altitude_m: 100
...
VITALS:
  T:38.0C HR:128 BP:108/64 GCS:9 SpO2:95% RR:26
...
LABS:
  WBC:13780 Plt:285000 ALT/AST:None CRP:1.2 PCT:None Na:138

CSF:
  OP:32.0cmH2O  WBC:6800/mm3  lymph%:9 neut%:90 eos%:1
  glucose:45mg/dL protein:454mg/dL lactate:Nonemmol/L ADA:NoneU/L
  crag_lfa:not_done  wet_mount:negative  xanthochromia:False  RBC:None

IMAGING:
  modality: ct_contrast  pattern: diffuse_cerebral_edema_basilar_meningeal_enhancement
  finding_count: None
...
```json
{
  ...
  "verification_method": "user_pubmed_ui_direct_fetch",
  "caveat": "6yo F Sichuan China, indoor heated pool 7d pre-onset April 2024, fulminant myocarditis presentation, ECMO-managed, novel candidate genotype k39_3, FATAL despite AmpB + rifampin. Same index patient as Li J 2025 Front Med (PMID 40969815) field investigation companion paper. Authors: Liangkang Lin, Lili Luo, Mei Wu, Jun Chen, Yi Liao, Haiyang Zhang."
}
```
...
```json
{
  ...
  "lastauthor": "Zhang H",
  "title": "Utilizing metagenomic next-generation sequencing and phylogenetic analysis to identify a rare pediatric case of Naegleria fowleri infection presenting with fulminant myocarditis.",
  "sorttitle": "utilizing metagenomic next generation sequencing and phylogenetic analysis to identify a rare pediatric case of naegleria fowleri infection presenting with fulminant myocarditis",
  "volume": "15",
  "issue": "",
  "pages": "1463822",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC11599265;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.3389/fmicb.2024.1463822"
    }
  ],
  "history": [
    {
    ...
    {
      "pubstatus": "medline",
      "date": "2024/11/28 06:36"
    },
    {
      "pubstatus": "pubmed",
      "date": "2024/11/28 06:35"
    },
    {
      "pubstatus": "entrez",
      "date": "2024/11/28 05:00"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "elocationid": "doi: 10.3389/fmicb.2024.1463822",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2024/11/13 00:00",
  "sortfirstauthor": "Lin L",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=023 file=pam_d2_023_lin_sichuan_myocarditis.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 6  sex: female  region: other_global
  ethnicity: other  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
  freshwater_exposure_14d: True (swimming_pool_unchlorinated)
...
VITALS:
  T:39.2C HR:184 BP:112/74 GCS:8 SpO2:98% RR:39
...
LABS:
  WBC:13000 Plt:434000 ALT/AST:None CRP:28.2 PCT:3.68 Na:170

CSF:
  OP:8.0cmH2O  WBC:960/mm3  lymph%:9 neut%:90 eos%:1
  glucose:85mg/dL protein:1000mg/dL lactate:7.8mmol/L ADA:NoneU/L
  crag_lfa:not_done  wet_mount:not_done  xanthochromia:False  RBC:3200
...
## Anchor: PMID 37727924 | Hong 2023
...
```json
{
  ...
  "caveat": "Korean man in 50s, 4-month Thailand stay, returned Korea 10 Dec 2022, symptoms began evening of arrival, admitted 11 Dec, died 21 Dec 2022 (13d post-onset); first imported PAM case in Korea; KDCA-confirmed 99.6% genetic match to overseas PAM strain. atypical_type=travel_imported_lake. 6 authors with hyphenated Korean given names (Kyung-Wook, Jong-Hwan, Jung-Hyun, Sung-Hee, Jung-Won, In-Gyu). Authors: Kyung-Wook Hong, Jong Hwan Jeong, Jung-Hyun Byun, Sung-Hee Hong, Jung-Won Ju, In-Gyu Bae."
}
```
...
```json
{
  ...
  "lastauthor": "Bae IG",
  "title": "Fatal Primary Amebic Meningoencephalitis due to Naegleria fowleri: The First Imported Case in Korea.",
  "sorttitle": "fatal primary amebic meningoencephalitis due to naegleria fowleri the first imported case in korea",
  "volume": "64",
  "issue": "10",
  "pages": "641-645",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC10522881;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.3349/ymj.2023.0189"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
  ...
  "history": [
    ...
    {
      "pubstatus": "medline",
      "date": "2023/09/21 06:42"
    },
    {
      "pubstatus": "pubmed",
      "date": "2023/09/20 06:42"
    },
    {
      "pubstatus": "entrez",
      "date": "2023/09/20 04:03"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "pmcrefcount": 18,
  "fulljournalname": "Yonsei medical journal",
  "elocationid": "doi: 10.3349/ymj.2023.0189",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2023/10/01 00:00",
  "sortfirstauthor": "Hong KW",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=024 file=pam_d2_024_hong_korea_thailand_travel.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 52  sex: male  region: other_global
  ethnicity: other  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:38.6C HR:108 BP:138/84 GCS:14 SpO2:96% RR:22
...
LABS:
  WBC:13070 Plt:245000 ALT/AST:None CRP:54.1 PCT:0.23 Na:138

CSF:
  OP:26.0cmH2O  WBC:1100/mm3  lymph%:5 neut%:94 eos%:1
  glucose:1mg/dL protein:1537mg/dL lactate:Nonemmol/L ADA:NoneU/L
  crag_lfa:not_done  wet_mount:not_done  xanthochromia:False  RBC:3168
...
## Anchor: PMID 25667249 | Linam 2015
...
```json
{
  ...
  "last_verified_date": "2026-05-05",
  "verification_method": "research_mode_4pass",
  "caveat": "12yo F (Kali Hardig); Willow Springs Water Park Arkansas July 2013; SURVIVED with combination antimicrobials (including miltefosine) + therapeutic hypothermia + ICP management on TBI principles; THIRD documented North American PAM survivor. 8 authors; preserve lowercase 'da' particle in 'da Silva AJ' per PubMed XML. Definitive case report subsequently invoked by Linam-Cope letter of concern PMID 28501613 against Heggie/Küpper PMID 28013053. Pairs with Burki 2024 Pakistan SURVIVOR (PMID 38526236) for outcome-contrast adjudication. Authors: W. Matthew Linam, Mubbasheer Ahmed, Jennifer R. Cope, Craig Chu, Govinda S. Visvesvara, Alexandre J. da Silva, Yvonne Qvarnstrom, Jerril Green."
}
```
...
```json
{
  ...
  "lastauthor": "Green J",
  "title": "Successful treatment of an adolescent with Naegleria fowleri primary amebic meningoencephalitis.",
  "sorttitle": "successful treatment of an adolescent with naegleria fowleri primary amebic meningoencephalitis",
  "volume": "135",
  "issue": "3",
  "pages": "e744-8",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC4634363;manuscript-id: NIHMS732021;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1542/peds.2014-2292"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
      "value": "peds.2014-2292"
    }
  ],
  "history": [
    {
  ...
  "pmcrefcount": 24,
  "fulljournalname": "Pediatrics",
  "elocationid": "doi: 10.1542/peds.2014-2292",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
...
- **pages**: registry='e744-e748' | ncbi='e744-8'

### Vignettes citing this anchor (1 total)

#### Vignette: vid=025 file=pam_d2_025_linam_kali_hardig_survivor.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 12  sex: female  region: us_south
  ethnicity: white_non_hispanic  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
  freshwater_exposure_14d: True (splash_pad)
...
VITALS:
  T:39.4C HR:110 BP:110/68 GCS:14 SpO2:98% RR:18

EXAM:
  mental_status: alert  neck_stiff: False  kernig_brudz: False
  cranial_nerve_palsy: none  papilledema: None  focal_deficit: False
  skin_lesion_centrofacial_chronic: False  rash: False

LABS:
  WBC:18400 Plt:245000 ALT/AST:None CRP:None PCT:None Na:138

CSF:
  OP:25.0cmH2O  WBC:3675/mm3  lymph%:14 neut%:86 eos%:0
  glucose:22mg/dL protein:374mg/dL lactate:Nonemmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:positive  xanthochromia:False  RBC:53
...
## Anchor: PMID 30055569 | Wang 2018
...
```json
{
  ...
  "lastauthor": "Liu Y",
  "title": "A case of Naegleria fowleri related primary amoebic meningoencephalitis in China diagnosed by next-generation sequencing.",
  "sorttitle": "case of naegleria fowleri related primary amoebic meningoencephalitis in china diagnosed by next generation sequencing",
  "volume": "18",
  "issue": "1",
  "pages": "349",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC6064090;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1186/s12879-018-3261-z"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
  ...
  "pmcrefcount": 17,
  "fulljournalname": "BMC infectious diseases",
  "elocationid": "doi: 10.1186/s12879-018-3261-z",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
...
#### Vignette: vid=026 file=pam_d2_026_wang_shenzhen_first_mainland.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 10  sex: male  region: other_global
  ethnicity: other  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:39.4C HR:138 BP:102/64 GCS:7 SpO2:95% RR:28
...
LABS:
  WBC:18200 Plt:245000 ALT/AST:None CRP:92.0 PCT:2.4 Na:137

CSF:
  OP:36.0cmH2O  WBC:3400/mm3  lymph%:9 neut%:90 eos%:1
  glucose:18mg/dL protein:380mg/dL lactate:7.6mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:not_done  xanthochromia:False  RBC:240
...
## Anchor: PMID 34906097 | Huang 2021
...
```json
{
  ...
  "issue": "1",
  "pages": "1251",
  "title": "A pediatric case of primary amoebic meningoencephalitis due to Naegleria fowleri diagnosed by next-generation sequencing of cerebrospinal fluid and blood samples",
  "anchor_type": "case_report",
  ...
  "last_verified_date": "2026-05-04",
  "verification_method": "user_pubmed_ui_direct_fetch",
  "caveat": "China pediatric mNGS dual-compartment positivity (CSF + blood, rare blood positivity). Authors 1+2 contributed equally. Author 'Xiu'an Liang' contains apostrophe in given name (UTF-8 preserved); Vancouver renders as 'Liang X'. Authors: Shiqin Huang, Xiu'an Liang, Yunli Han, Yanyan Zhang, Xinhui Li, Zhiyong Yang."
}
```
...
```json
{
  ...
  "lastauthor": "Yang Z",
  "title": "A pediatric case of primary amoebic meningoencephalitis due to Naegleria fowleri diagnosed by next-generation sequencing of cerebrospinal fluid and blood samples.",
  "sorttitle": "pediatric case of primary amoebic meningoencephalitis due to naegleria fowleri diagnosed by next generation sequencing of cerebrospinal fluid and blood samples",
  "volume": "21",
  "issue": "1",
  "pages": "1251",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC8670243;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1186/s12879-021-06932-9"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
  ...
  "history": [
    ...
    {
      "pubstatus": "entrez",
      "date": "2021/12/15 05:43"
    },
    {
      "pubstatus": "pubmed",
      "date": "2021/12/16 06:00"
    },
    {
      "pubstatus": "medline",
      "date": "2021/12/17 06:00"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "pmcrefcount": 11,
  "fulljournalname": "BMC infectious diseases",
  "elocationid": "doi: 10.1186/s12879-021-06932-9",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2021/12/14 00:00",
  "sortfirstauthor": "Huang S",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=027 file=pam_d2_027_huang_china_mngs_dual.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 8  sex: male  region: other_global
  ethnicity: other  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:39.0C HR:132 BP:100/62 GCS:11 SpO2:96% RR:26
...
LABS:
  WBC:16400 Plt:268000 ALT/AST:None CRP:78.0 PCT:1.8 Na:138

CSF:
  OP:28.0cmH2O  WBC:2400/mm3  lymph%:11 neut%:88 eos%:1
  glucose:22mg/dL protein:320mg/dL lactate:6.4mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:not_done  xanthochromia:False  RBC:120
...
## Anchor: PMID 39860533 | Rîpă 2025
...
```json
{
  ...
  "caveat": "7-author Romanian systematic review (Iasi, Univ Med & Pharmacy Grigore T. Popa) of 52 PAM case-report articles via Web of Science search. Abstract reports 98 patients (17 women 17.4%, 81 men 82.6%) from 17 countries: 17 USA, 8 India, 7 China, 4 Pakistan, 2 UK, plus 1 each from Thailand/Korea/Japan/Italy/Iran/Norway/Turkey/Costa Rica/Zambia/Australia/Taiwan/Venezuela/Mexico. Mortality reported at 88-98% across discussion. Note: results section internally reports 99 patients (17F/82M = 17.17%/82.82%) diverging slightly from abstract's 98 (17F/81M); use abstract figures as canonical for vignette anchoring. UTF-8 diacritics preserved: Rîpă (î U+00EE, ă U+0103), Maștaleru (ș U+0219), Cumpăt (ă U+0103). Anchor for global epidemiology + demographics Tier-4 vignettes. Replaces mis-attributed 98-patient stat previously in Hall 2024 caveat (corrected 2026-05-05)."
}
```
...
```json
{
  ...
  "lastauthor": "Leon MM",
  "title": "Naegleria fowleri Infections: Bridging Clinical Observations and Epidemiological Insights.",
  "sorttitle": "naegleria fowleri infections bridging clinical observations and epidemiological insights",
  "volume": "14",
  "issue": "2",
  "pages": "",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC11765897;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.3390/jcm14020526"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
  ...
  "history": [
    ...
    {
      "pubstatus": "medline",
      "date": "2025/01/25 13:53"
    },
    {
      "pubstatus": "pubmed",
      "date": "2025/01/25 13:52"
    },
    {
      "pubstatus": "entrez",
      "date": "2025/01/25 01:23"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "elocationid": "doi: 10.3390/jcm14020526",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2025/01/15 00:00",
  "sortfirstauthor": "Rîpă C",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=038 file=pam_d2_038_ripa_global_review_imputed.json class=1 subphase=1.2 PAM Day2
...
VITALS:
  T:39.0C HR:110 BP:122/76 GCS:11 SpO2:96% RR:20
...
LABS:
  WBC:17400 Plt:248000 ALT/AST:None CRP:86.0 PCT:1.8 Na:137

CSF:
  OP:30.0cmH2O  WBC:3000/mm3  lymph%:9 neut%:90 eos%:1
  glucose:22mg/dL protein:360mg/dL lactate:6.8mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:not_done  xanthochromia:False  RBC:160
...
## Anchor: PMID 32369575 | Gharpure 2021
...
```json
{
  ...
  "issue": "1",
  "pages": "e19-e27",
  "title": "Epidemiology and Clinical Characteristics of Primary Amebic Meningoencephalitis Caused by Naegleria fowleri: A Global Review",
  "anchor_type": "review",
  "anchor_subtype": "review_global",
  "pmc_id": "PMC8739754",
  "verification_confidence": 99,
  "last_verified_date": "2026-05-04",
  "caveat": "Global PAM review, 381 cases 1937-2018, US 41% / Pakistan 11% / Mexico 9%. Companion to Capewell 2015 (US-only)."
}
```
...
```json
{
  ...
  "lastauthor": "Cope JR",
  "title": "Epidemiology and Clinical Characteristics of Primary Amebic Meningoencephalitis Caused by Naegleria fowleri: A Global Review.",
  "sorttitle": "epidemiology and clinical characteristics of primary amebic meningoencephalitis caused by naegleria fowleri a global review",
  "volume": "73",
  "issue": "1",
  "pages": "e19-e27",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC8739754;manuscript-id: NIHMS1724410;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1093/cid/ciaa520"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
  ...
  "history": [
    ...
    {
      "pubstatus": "pubmed",
      "date": "2020/05/06 06:00"
    },
    {
      "pubstatus": "medline",
      "date": "2021/07/08 06:00"
    },
    {
      "pubstatus": "entrez",
      "date": "2020/05/06 06:00"
  ...
  "elocationid": "doi: 10.1093/cid/ciaa520",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
...
### Vignettes citing this anchor (2 total)

#### Vignette: vid=039 file=pam_d2_039_gharpure_cid_imputed_lake.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 13  sex: male  region: us_south
  ethnicity: white_non_hispanic  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:39.5C HR:122 BP:110/68 GCS:7 SpO2:95% RR:24
...
LABS:
  WBC:19200 Plt:240000 ALT/AST:None CRP:102.0 PCT:2.6 Na:136

CSF:
  OP:38.0cmH2O  WBC:4200/mm3  lymph%:7 neut%:92 eos%:1
  glucose:16mg/dL protein:420mg/dL lactate:8.4mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:positive  xanthochromia:False  RBC:280
...
#### Vignette: vid=058 file=pam_d2_058_gharpure_cid_imputed_neti.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  ...
  pregnancy_red_flag: False
  immunocompromise_status: none
  freshwater_exposure_14d: True (neti_pot_tap_water)
...
VITALS:
  T:39.4C HR:106 BP:132/80 GCS:7 SpO2:95% RR:22
...
LABS:
  WBC:19000 Plt:240000 ALT/AST:None CRP:126.0 PCT:3.2 Na:134

CSF:
  OP:38.0cmH2O  WBC:4580/mm3  lymph%:7 neut%:92 eos%:1
  glucose:12mg/dL protein:468mg/dL lactate:8.8mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:positive  xanthochromia:False  RBC:280
...
## Anchor: PMID 19845995 | Yoder 2010
...
```json
{
  ...
  "verification_confidence": 99,
  "last_verified_date": "2026-05-04",
  "caveat": "Foundational US PAM surveillance covering 111 cases 1962-2008."
}
```
...
```json
{
  ...
  "lastauthor": "Beach MJ",
  "title": "The epidemiology of primary amoebic meningoencephalitis in the USA, 1962-2008.",
  "sorttitle": "epidemiology of primary amoebic meningoencephalitis in the usa 1962 2008",
  "volume": "138",
  "issue": "7",
  "pages": "968-75",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1017/S0950268809991014"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
      "value": "S0950268809991014"
    }
  ],
  "history": [
    {
      "pubstatus": "entrez",
      "date": "2009/10/23 06:00"
    },
    {
      "pubstatus": "pubmed",
      "date": "2009/10/23 06:00"
  ...
  "pmcrefcount": "",
  "fulljournalname": "Epidemiology and infection",
  "elocationid": "doi: 10.1017/S0950268809991014",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2010/07/01 00:00",
  "sortfirstauthor": "Yoder JS",
  "vernaculartitle": ""
}
```
...
- **pages**: registry='968-975' | ncbi='968-75'

### Vignettes citing this anchor (1 total)

#### Vignette: vid=040 file=pam_d2_040_yoder2010_us_review_imputed.json class=1 subphase=1.2 PAM Day2
...
VITALS:
  T:39.2C HR:116 BP:110/68 GCS:11 SpO2:96% RR:22
...
LABS:
  WBC:17800 Plt:250000 ALT/AST:None CRP:84.0 PCT:1.8 Na:138

CSF:
  OP:30.0cmH2O  WBC:2800/mm3  lymph%:10 neut%:89 eos%:1
  glucose:22mg/dL protein:340mg/dL lactate:6.6mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:not_done  xanthochromia:False  RBC:160
...
## Anchor: PMID 35463884 | Zhou 2022
...
```json
{
  ...
  "caveat": "Pediatric case + literature review. Strong physician-adjudicator anchor for misdiagnosis-as-bacterial-meningitis differential. Geography corrected 2026-05-05 via verification audit (compass_artifact_wf-c3f74c5c): Changsha, Hunan Province, China (Third Xiangya Hospital, Central South University); NOT Hainan. Hainan is the tropical island province in South China Sea; Hunan is a landlocked central-China province; distinct geographies. Sources confirming Hunan/Changsha: PubMed affiliations, PMC9033202 body text, Frontiers article page. 7 authors confirmed (NOT 6 as initially inferred from snippets). Authors: Wenjuan Zhou, Yuzhen Ouyang, Di Zhang, Sheng Liao, Hui Liang, Lingling Zhao, Chunyuan Chen."
}
```
...
```json
{
  ...
  "lastauthor": "Chen C",
  "title": "Case Report and Literature Review: Bacterial Meningoencephalitis or Not? Naegleria fowleri Related Primary Amoebic Meningoencephalitis in China.",
  "sorttitle": "case report and literature review bacterial meningoencephalitis or not naegleria fowleri related primary amoebic meningoencephalitis in china",
  "volume": "10",
  "issue": "",
  "pages": "785735",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC9033202;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.3389/fped.2022.785735"
    }
  ],
  "history": [
    {
    ...
    {
      "pubstatus": "entrez",
      "date": "2022/04/25 05:25"
    },
    {
      "pubstatus": "pubmed",
      "date": "2022/04/26 06:00"
    },
    {
      "pubstatus": "medline",
      "date": "2022/04/26 06:01"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "pmcrefcount": 26,
  "fulljournalname": "Frontiers in pediatrics",
  "elocationid": "doi: 10.3389/fped.2022.785735",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2022/04/08 00:00",
  "sortfirstauthor": "Zhou W",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=041 file=pam_d2_041_zhou_hunan_misdiagnosis.json class=1 subphase=1.2 PAM Day2
...
DEMOGRAPHICS:
  age_years: 14  sex: male  region: other_global
  ethnicity: other  altitude_m: 100
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:39.6C HR:124 BP:108/66 GCS:8 SpO2:95% RR:24
...
LABS:
  WBC:18600 Plt:244000 ALT/AST:None CRP:108.0 PCT:2.8 Na:136

CSF:
  OP:36.0cmH2O  WBC:4400/mm3  lymph%:7 neut%:92 eos%:1
  glucose:14mg/dL protein:438mg/dL lactate:8.2mmol/L ADA:NoneU/L
  crag_lfa:negative  wet_mount:positive  xanthochromia:False  RBC:240
