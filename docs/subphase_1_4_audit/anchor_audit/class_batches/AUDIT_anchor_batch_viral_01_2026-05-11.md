# AUDIT batch: class=viral batch=1/1

Generated: 2026-05-11
Vignettes in bundle: 2
Anchors in bundle: 2
Build status: NCBI fetched (mixed)
Bundle type: CLASS-LOCKED-BATCH (class viral, small clusters packed)

## Anchors in this batch

- pmid:17668054 (Michos 2007, n=1)
- pmid:38300858 (Munayco 2024, n=1)

## Anchor: PMID 17668054 | Michos 2007
...
```json
{
  ...
  "lastauthor": "Theodoridou M",
  "title": "Aseptic meningitis in children: analysis of 506 cases.",
  "sorttitle": "aseptic meningitis in children analysis of 506 cases",
  "volume": "2",
  "issue": "7",
  "pages": "e674",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC1933255;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1371/journal.pone.0000674"
    }
  ],
  "history": [
    {
    ...
    {
      "pubstatus": "pubmed",
      "date": "2007/08/02 09:00"
    },
    {
      "pubstatus": "medline",
      "date": "2007/08/02 09:01"
    },
    {
      "pubstatus": "entrez",
      "date": "2007/08/02 09:00"
...
#### Vignette: vid=105 file=vir_105_enterovirus_pediatric.json class=3 subphase=1.3 VIRAL
...
DEMOGRAPHICS:
  age_years: 5  sex: male  region: other_global
  ethnicity: white_non_hispanic  altitude_m: 200
...
LABS:
  WBC:11200 Plt:285000 ALT/AST:22 CRP:18.0 PCT:0.3 Na:138

CSF:
  OP:18.0cmH2O  WBC:220/mm3  lymph%:35 neut%:65 eos%:0
  glucose:55mg/dL protein:65mg/dL lactate:2.4mmol/L ADA:NoneU/L
...
## Anchor: PMID 38300858 | Munayco 2024
...
```json
{
  ...
  "authors": [
    ...
    {
      "name": "Valderrama Rosales BY",
      "authtype": "Author",
      "clusterid": ""
    },
    {
      "name": "Mateo Lizarbe SY",
      "authtype": "Author",
      "clusterid": ""
    },
    {
  ...
  "lastauthor": "Paz-Bailey G",
  "title": "Notes from the Field: Dengue Outbreak - Peru, 2023.",
  "sorttitle": "notes from the field dengue outbreak peru 2023",
  "volume": "73",
  "issue": "4",
  "pages": "86-88",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "pmcid",
      "idtypen": 5,
      "value": "pmc-id: PMC10843068;"
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.15585/mmwr.mm7304a4"
    }
  ],
  "history": [
    {
      "pubstatus": "medline",
      "date": "2024/02/05 06:43"
    },
    {
      "pubstatus": "pubmed",
      "date": "2024/02/01 18:41"
    },
    {
      "pubstatus": "entrez",
      "date": "2024/02/01 13:13"
    },
    {
      "pubstatus": "pmc-release",
  ...
  "elocationid": "doi: 10.15585/mmwr.mm7304a4",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
...
#### Vignette: vid=118 file=vir_118_dengue_loreto.json class=3 subphase=1.3 VIRAL
...
DEMOGRAPHICS:
  age_years: 32  sex: female  region: peru_loreto_amazon
  ethnicity: mestizo  altitude_m: 106
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
  freshwater_exposure_14d: False (None)
...
VITALS:
  T:39.6C HR:116 BP:110/70 GCS:12 SpO2:96% RR:22
...
LABS:
  WBC:4200 Plt:65000 ALT/AST:145 CRP:32.0 PCT:0.6 Na:134

CSF:
  OP:18.0cmH2O  WBC:85/mm3  lymph%:70 neut%:30 eos%:0
  glucose:62mg/dL protein:75mg/dL lactate:2.6mmol/L ADA:NoneU/L
