# AUDIT batch: class=bact batch=1/1

Generated: 2026-05-11
Vignettes in bundle: 4
Anchors in bundle: 3
Build status: NCBI fetched (mixed)
Bundle type: CLASS-LOCKED-BATCH (class bact, small clusters packed)

## Anchors in this batch

- pmid:27831604 (Davalos 2016, n=1)
- pmid:18626301 (Heckenberg 2008, n=1)
- pmid:11873028 (Mylonakis 2002, n=2)

## Anchor: PMID 27831604 | Davalos 2016
...
```json
{
  ...
  "sorttitle": "epidemiologic clinical and bacteriologic characteristics of pneumococcal meningitis in pediatric patients from lima peru",
  "volume": "33",
  "issue": "3",
  "pages": "425-431",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.17843/rpmesp.2016.333.2349"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
      "value": "S1726-46342016000300425"
    }
  ],
  "history": [
    {
  ...
  "pmcrefcount": "",
  "fulljournalname": "Revista peruana de medicina experimental y salud publica",
  "elocationid": "doi: 10.17843/rpmesp.2016.333.2349",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2016/07/01 00:00",
  "sortfirstauthor": "Davalos L",
  "vernaculartitle": "Características epidemiológicas, clínicas y bacteriológicas de meningitis neumocócica en pacientes pediátricos de Lima, Perú."
}
```

### Registry-vs-NCBI delta

- **doi**: registry='10.17843/rpmesp.2016.333.2317' | ncbi='10.17843/rpmesp.2016.333.2349'

### Vignettes citing this anchor (1 total)

#### Vignette: vid=064 file=bact_064_sp_lima_pediatric.json class=2 subphase=1.3 BACT
...
DEMOGRAPHICS:
  age_years: 1  sex: male  region: peru_lima_coast
...
VITALS:
  T:39.5C HR:156 BP:92/56 GCS:12 SpO2:96% RR:32
...
LABS:
  WBC:21000 Plt:280000 ALT/AST:28 CRP:220.0 PCT:12.0 Na:135

CSF:
  OP:32.0cmH2O  WBC:5400/mm3  lymph%:8 neut%:92 eos%:0
  glucose:18mg/dL protein:280mg/dL lactate:8.0mmol/L ADA:NoneU/L
...
## Anchor: PMID 18626301 | Heckenberg 2008
...
```json
{
  ...
  "title": "Clinical features, outcome, and meningococcal genotype in 258 adults with meningococcal meningitis: a prospective cohort study.",
  "sorttitle": "clinical features outcome and meningococcal genotype in 258 adults with meningococcal meningitis a prospective cohort study",
  "volume": "87",
  "issue": "4",
  "pages": "185-192",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1097/MD.0b013e318180a6b4"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
      "value": "00005792-200807000-00001"
    }
  ],
  "history": [
    {
  ...
  "elocationid": "doi: 10.1097/MD.0b013e318180a6b4",
  "doctype": "citation",
  "srccontriblist": [],
  "booktitle": "",
  "medium": "",
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2008/07/01 00:00",
  "sortfirstauthor": "Heckenberg SGB",
  "vernaculartitle": ""
}
```
...
#### Vignette: vid=082 file=bact_082_nm_college_outbreak.json class=2 subphase=1.3 BACT
...
DEMOGRAPHICS:
  age_years: 24  sex: male  region: other_global
...
VITALS:
  T:39.8C HR:124 BP:110/68 GCS:13 SpO2:96% RR:24
...
LABS:
  WBC:16800 Plt:195000 ALT/AST:38 CRP:168.0 PCT:6.2 Na:136

CSF:
  OP:24.0cmH2O  WBC:2100/mm3  lymph%:15 neut%:85 eos%:0
  glucose:30mg/dL protein:145mg/dL lactate:5.8mmol/L ADA:NoneU/L
...
## Anchor: PMID 11873028 | Mylonakis 2002
...
```json
{
  ...
  "caveat": "Listeria monocytogenes infection during pregnancy review of 222 cases. Anchor for Class 2 pregnancy-Listeria vignettes; documents maternal-fetal transmission, third-trimester presentation, and high neonatal morbidity. verification_confidence=0.85 pre-direct-fetch."
}
```
...
```json
{
  ...
  "lastauthor": "Dahan A",
  "title": "The influence of remifentanil on the dynamic relationship between sevoflurane and surrogate anesthetic effect measures derived from the EEG.",
  "sorttitle": "influence of remifentanil on the dynamic relationship between sevoflurane and surrogate anesthetic effect measures derived from the eeg",
  "volume": "96",
  "issue": "3",
  "pages": "555-64",
  "lang": [
  ...
  "articleids": [
    ...
    },
    {
      "idtype": "doi",
      "idtypen": 3,
      "value": "10.1097/00000542-200203000-00009"
    },
    {
      "idtype": "pii",
      "idtypen": 4,
      "value": "00000542-200203000-00009"
    }
  ],
  "history": [
    {
      "pubstatus": "pubmed",
      "date": "2002/03/02 10:00"
    },
    {
      "pubstatus": "medline",
      "date": "2002/04/18 10:01"
    },
    {
      "pubstatus": "entrez",
      "date": "2002/03/02 10:00"
  ...
  "bookname": "",
  "chapter": "",
  "sortpubdate": "2002/03/01 00:00",
  "sortfirstauthor": "Olofsen E",
  "vernaculartitle": ""
}
```
...
- **first_author_surname**: registry='Mylonakis' | ncbi='Olofsen E'
- **journal**: registry='Medicine (Baltimore)' | ncbi='Anesthesiology'
- **volume**: registry='81' | ncbi='96'
- **issue**: registry='4' | ncbi='3'
- **pages**: registry='260-269' | ncbi='555-64'
- **doi**: registry='10.1097/00005792-200203000-00004' | ncbi='10.1097/00000542-200203000-00009'

### Vignettes citing this anchor (2 total)

#### Vignette: vid=088 file=bact_088_listeria_tumbes_pregnancy.json class=2 subphase=1.3 BACT
...
DEMOGRAPHICS:
  age_years: 28  sex: female  region: peru_tumbes
...
VITALS:
  T:38.6C HR:102 BP:110/68 GCS:14 SpO2:97% RR:20
...
LABS:
  WBC:14500 Plt:220000 ALT/AST:24 CRP:88.0 PCT:2.4 Na:137

CSF:
  OP:22.0cmH2O  WBC:1500/mm3  lymph%:45 neut%:55 eos%:0
  glucose:28mg/dL protein:130mg/dL lactate:4.0mmol/L ADA:NoneU/L
...
#### Vignette: vid=089 file=bact_089_listeria_elderly.json class=2 subphase=1.3 BACT
...
DEMOGRAPHICS:
  age_years: 76  sex: female  region: other_global
  ethnicity: white_non_hispanic  altitude_m: 5
  hiv_status: negative  cd4: None
  pregnancy_red_flag: False
  immunocompromise_status: none
...
VITALS:
  T:38.4C HR:96 BP:132/78 GCS:12 SpO2:95% RR:20

EXAM:
  mental_status: confused  neck_stiff: True  kernig_brudz: True
  cranial_nerve_palsy: CN_VII  papilledema: False  focal_deficit: True
  skin_lesion_centrofacial_chronic: False  rash: False

LABS:
  WBC:15800 Plt:215000 ALT/AST:32 CRP:105.0 PCT:3.8 Na:134

CSF:
  OP:24.0cmH2O  WBC:1800/mm3  lymph%:40 neut%:60 eos%:0
  glucose:25mg/dL protein:145mg/dL lactate:4.4mmol/L ADA:NoneU/L
