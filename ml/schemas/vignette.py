...
class ExposureHistory(BaseModel):
    ...
    def _freshwater_type_requires_exposure(self) -> Self:
...
class CSFProfile(BaseModel):
    ...
    @model_validator(mode="after")
    def _csf_differential_sums_to_100(self) -> Self:
...
class VignetteSchema(BaseModel):
    ...
    @model_validator(mode="after")
    def _pam_always_flag_rule(self) -> Self:
    ...
    @model_validator(mode="after")
    def _cryptococcal_cd4_required_when_hiv(self) -> Self:
